...
export const CreateJobForm = ({ onBack }: CreateJobFormProps) => {
  ...
  return (
    <form
      ...
      className="bg-gray-100 min-h-screen px-6 py-7 font-sans"
    >
      {/* Top bar */}
      ...
      >
        ...
        <div>
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <textarea
                    ...
                    aria-invalid={fieldState.invalid}
                    className={`${
                      fieldState.invalid ? errorInput : baseInput
          ...
          <CardSection
            icon="📍"
            title="Logistics"
            subtitle="Location, work mode & contract"
          >
            <div className="grid grid-cols-2 gap-3">
              {/* Location */}
              <Controller
          ...
          <CardSection
            ...
            subtitle="What candidates need to qualify"
          >
              ...
              render={({ fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <div
                    ...
                    onClick={() =>
                      document.getElementById("skill-inp")?.focus()
                    }
                  >
        ...
        <div>
            ...
            <div className="p-3.5 flex flex-col gap-3">
              <div>
                <div className="flex justify-between mb-1.5">
                  ...
                  <span
                    className={`text-xs font-medium ${
                      pct === 100 ? "text-green-700" : "text-gray-900"
                    }`}
                  >
                    {pct}%
                  </span>
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden mb-3">
            ...
            <div className="p-3.5 flex flex-col gap-2">
              ...
              />
              <p className="text-xs text-gray-400">
                Used as cover on your job listing page
              </p>
            </div>
          </div>
